...
const MainPage = () => {
    ...
    return (
        <div className="scroll-auto h-[80vh] overflow-y-auto scrollbar-hide">
            ...
            <div>
                <div
                    className="relative bg-[#373737] py-4 blur-[50] mx-auto w-96 h-full rounded-xl shadow-2xl"
                >
                ...
                <div className="flex mt-5">
                    <div
                        className="relative bg-[#373737] py-4 blur-[50] mx-auto w-44 h-full rounded-xl shadow-2xl"
                    >
